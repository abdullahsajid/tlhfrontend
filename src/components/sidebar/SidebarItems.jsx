...
const SidebarItems = ({label,Icon,active,onActive,endpoint}) => {
  return (
    ...
    rounded-md transition-all hover:bg-slate-900 hover:text-[#fff] cursor-pointer ${active ? "bg-slate-900 !text-[#fff] hover:bg-slate-900/90 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50/90" : ""}`}>

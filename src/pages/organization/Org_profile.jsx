        ...
        <div className='relative w-full z-[0] transition-all'>
          <div className='w-full bg-[#f6f6f7] rounded-md border border-solid border-[#f6f6f7] shadow'>
            {fakeLoading ? <Skeleton style={{ height: "300px", width: '100%', border: '2px solid #fff' }} /> :
              <img src={`${!(data?.banner_url) ? 'https://tlhfrontend.vercel.app/pxfuel.jpg' : data?.banner_url}`}
          ...
          <div className='absolute left-24 max-sm:left-16 z-[100] custom-position-center bg-[#f6f6f7] rounded-md border border-solid border-[#f6f6f7] shadow'>
            {fakeLoading ? <Skeleton style={{ width: '8rem', height: '8rem', borderRadius: '0.375rem', border: '2px solid #fff' }} /> : 
              <img src={`${!(data?.avatar_url) ? 'https://tlhfrontend.vercel.app/avatar-org.jpg' : data?.avatar_url}`} className='w-32 h-32 max-sm:w-28 max-sm:h-28 rounded-md object-cover' />}
          </div>

                ...
                <div className='flex flex-col relative z-0'>
                    ...
                    <div className='flex flex-col justify-center relative h-[100px] max-w-[100px] mt-[-3rem] ml-[1rem] rounded-md mb-3'>
                        <div className='rounded-md'>
                            <img src="https://avatars.githubusercontent.com/u/77003390?v=4" alt="" className=' rounded-md' />
                        </div>
                    </div>
                    ...
                    <div className='px-3 py-3 flex flex-col gap-y-2'>
                        ...
                        <textarea id="edu" rows="2" className='px-2 py-2 rounded-md shadow-md outline-none w-full border-solid border-2 border-slate-300'></textarea>
                    </div>
                    <div className='px-3 py-3 flex flex-col gap-y-2'>
                        <label htmlFor="exp" className='font-semibold'>Experience:</label>
                        <textarea id="exp" rows="2" className='px-2 py-2 rounded-md shadow-md outline-none w-full border-solid border-2 border-slate-300'></textarea>
                    </div>
